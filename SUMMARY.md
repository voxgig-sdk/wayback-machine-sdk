...
Results: Successful response with snapshot availability information.
...
| --- | --- | --- | --- |
| Availability | `load` | `GET /wayback/available` | See reference |

## Connect to the API

- Internet Archive production server: `https://archive.org`
...
- `wayback-machine_list`: List records for an entity. No active entity supports this operation.
- `wayback-machine_load`: Load one record for an entity. Supported entities: `availability`.
