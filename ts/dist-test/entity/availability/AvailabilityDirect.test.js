...
(0, node_test_1.describe)('AvailabilityDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.WaybackMachineSDK({
    ...
    (0, node_test_1.test)('direct-load-availability', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-availability', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.WAYBACK_MACHINE_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.WaybackMachineSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['WAYBACK_MACHINE_TEST_AVAILABILITY_ENTID'];
    ...
    const client = new __1.WaybackMachineSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=AvailabilityDirect.test.js.map