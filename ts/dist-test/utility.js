...
function envOverride(m) {
    if ('TRUE' === process.env.WAYBACK_MACHINE_TEST_LIVE ||
        'TRUE' === process.env.WAYBACK_MACHINE_TEST_OVERRIDE) {
    ...
    m.WAYBACK_MACHINE_TEST_EXPLAIN = process.env.WAYBACK_MACHINE_TEST_EXPLAIN || m.WAYBACK_MACHINE_TEST_EXPLAIN;
    return m;
}
