...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.WAYBACKMACHINE_TEST_LIVE ||
    'TRUE' === process.env.WAYBACKMACHINE_TEST_OVERRIDE
  ) {
  ...
  m.WAYBACKMACHINE_TEST_EXPLAIN = process.env.WAYBACKMACHINE_TEST_EXPLAIN || m.WAYBACKMACHINE_TEST_EXPLAIN
