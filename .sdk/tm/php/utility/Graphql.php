...
// WaybackMachine SDK utility: graphql
//
...
class WaybackMachineGraphql
{
    ...
    // equivalent.
    public static function body(WaybackMachineContext $ctx): mixed
    {
    ...
    public static function errors(WaybackMachineContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
