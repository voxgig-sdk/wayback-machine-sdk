...
// WaybackMachine SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class WaybackMachineMakeRequest
{
    public static function call(WaybackMachineContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new WaybackMachineResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new WaybackMachineResponse($fetched);
        } else {
