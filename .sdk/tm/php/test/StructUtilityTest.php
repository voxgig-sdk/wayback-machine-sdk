...
// WaybackMachine SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = WaybackMachineOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(WaybackMachineOmni::structfix($now, Struct::undef()))
                        !== json_encode(WaybackMachineOmni::structfix($val, Struct::undef()))) {
