...
// WaybackMachine SDK streaming feature
...
class WaybackMachineStreamingFeature extends WaybackMachineBaseFeature
{
    ...
    private function _iterate(WaybackMachineResult $result): \Generator
    {
    ...
    private function _streamable(WaybackMachineContext $ctx): bool
    {
