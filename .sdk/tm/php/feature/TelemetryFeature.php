...
// WaybackMachine SDK telemetry feature
...
class WaybackMachineTelemetryFeature extends WaybackMachineBaseFeature
{
    ...
    private function _close(WaybackMachineContext $ctx, bool $ok): void
    {
