...
// WaybackMachine SDK metrics feature
...
class WaybackMachineMetricsFeature extends WaybackMachineBaseFeature
{
    ...
    private function _record(WaybackMachineContext $ctx, bool $ok): void
    {
