...
// WaybackMachine SDK clienttrack feature
...
class WaybackMachineClienttrackFeature extends WaybackMachineBaseFeature
{
    ...
    public function PostConstruct(WaybackMachineContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'WaybackMachine-SDK';
