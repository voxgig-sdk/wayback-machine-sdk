...
// WaybackMachine SDK rbac feature
...
class WaybackMachineRbacFeature extends WaybackMachineBaseFeature
{
    ...
    private function _required(WaybackMachineContext $ctx): ?string
    {
    ...
    private function _reject(WaybackMachineContext $ctx, string $required): void
    {
    ...
    private function _track(WaybackMachineContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
