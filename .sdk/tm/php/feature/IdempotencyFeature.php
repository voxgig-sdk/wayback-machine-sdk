...
// WaybackMachine SDK idempotency feature
...
class WaybackMachineIdempotencyFeature extends WaybackMachineBaseFeature
{
    ...
    private function _mutating(WaybackMachineContext $ctx): bool
    {
