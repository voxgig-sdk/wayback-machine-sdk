...
// WaybackMachine SDK proxy feature
...
class WaybackMachineProxyFeature extends WaybackMachineBaseFeature
{
    ...
    public function init(WaybackMachineContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (WaybackMachineContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
