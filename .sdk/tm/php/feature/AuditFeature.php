...
// WaybackMachine SDK audit feature
...
class WaybackMachineAuditFeature extends WaybackMachineBaseFeature
{
    ...
    private function _emit(WaybackMachineContext $ctx, string $outcome): void
    {
