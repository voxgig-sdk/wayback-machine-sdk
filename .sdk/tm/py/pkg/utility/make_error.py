# WaybackMachine SDK utility: make_error
...
def make_error_util(ctx, err):
    if ctx is None:
        ...
        ctx = WaybackMachineContext({}, None)
    ...
    errmsg = ""
    if isinstance(err, WaybackMachineError):
        errmsg = err.msg
    ...
    msg = "WaybackMachineSDK: " + opname + ": " + errmsg
    ...
    sdk_err = WaybackMachineError("", msg, ctx)
