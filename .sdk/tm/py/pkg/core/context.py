...
from projectname_sdk.core.control import WaybackMachineControl
...
class WaybackMachineContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = WaybackMachineControl()
        ...
        if isinstance(sp, WaybackMachineSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, WaybackMachineResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, WaybackMachineResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return WaybackMachineOperation({})
    ...
    def make_error(self, code, msg):
        return WaybackMachineError(code, msg, self)
