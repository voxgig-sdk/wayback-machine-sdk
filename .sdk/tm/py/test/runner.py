...
class WaybackMachineTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = WaybackMachineTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = WaybackMachineTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = WaybackMachineTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
