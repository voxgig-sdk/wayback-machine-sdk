...
class WaybackMachineTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = WaybackMachineTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = WaybackMachineTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = WaybackMachineTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
