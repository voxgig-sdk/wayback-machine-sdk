...
|---|---|---|
| `ts/` | @voxgig-sdk/wayback-machine-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/wayback-machine-sdk \
      --repository voxgig-sdk/wayback-machine-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/wayback-machine-sdk` shows it, and
`npm trust revoke @voxgig-sdk/wayback-machine-sdk --id=<id>` removes it.
