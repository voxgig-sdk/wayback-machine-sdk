...
class WaybackMachineSDK
{
    ...
    public function __construct(array $options = [])
    {
        ...
        $feature_opts = WaybackMachineHelpers::to_map(Struct::getprop($this->options, "feature"));
        if ($feature_opts) {
            $featureorder = Struct::getpath($this->options, "__derived__.featureorder");
            if (is_array($featureorder)) {
                foreach ($featureorder as $fname) {
                    $fopts = WaybackMachineHelpers::to_map($feature_opts[$fname] ?? null);
                    if ($fopts && isset($fopts["active"]) && $fopts["active"] === true) {
                        ...
                        if (!WaybackMachineFeatures::has_feature($fname)) {
                        ...
                        ($utility->feature_add)($this->_rootctx, WaybackMachineFeatures::make_feature($fname));
                    }
                }
            }
        }
    ...
    {
        return WaybackMachineUtility::copy($this->_utility);
    }
    ...
    public function prepare(array $fetchargs = []): mixed
    {
        ...
        $ctrl = WaybackMachineHelpers::to_map(Struct::getprop($fetchargs, "ctrl")) ?? [];
        ...
        $params = WaybackMachineHelpers::to_map(Struct::getprop($fetchargs, "params")) ?? [];
        $query = WaybackMachineHelpers::to_map(Struct::getprop($fetchargs, "query")) ?? [];
    ...
    private function op_denied(string $op): array
    {
        ...
        return [
            "ok" => false,
            "err" => new WaybackMachineError($op . "_allow",
                "WaybackMachineSDK: " . $op . ": operation not allowed by" .
    ...
    private function raw_request(array $fetchargs = []): mixed
    {
        ...
        if (is_array($fetched)) {
            $status = WaybackMachineHelpers::to_int(Struct::getprop($fetched, "status"));
    ...
    public function graphql(string $query, ?array $variables = null, ?array $ctrl = null): mixed
    {
        ...
        if (is_array($errors) && 0 < count($errors)) {
            ...
            $res["ok"] = false;
            $res["err"] = new WaybackMachineError("graphql_error",
                "WaybackMachineSDK: graphql: " . $msg);
            $res["graphql"] = $errors;
        }
    ...
    public function Availability($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_availability === null) {
                $this->_availability = new AvailabilityEntity($this, null);
            }
            return $this->_availability;
        }
        return new AvailabilityEntity($this, $data);
    }
    ...
    public static function test(?array $testopts = null, ?array $sdkopts = null): self
    {
        ...
        $sdk = new WaybackMachineSDK($sdkopts);
        $sdk->mode = "test";
        return $sdk;
    }
}
