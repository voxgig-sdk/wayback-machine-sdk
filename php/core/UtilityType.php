...
// WaybackMachine SDK utility type

class WaybackMachineUtility
{
    ...
    public static function copy(WaybackMachineUtility $src): WaybackMachineUtility
    {
        $u = new WaybackMachineUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
