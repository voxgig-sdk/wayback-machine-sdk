...
class AvailabilityEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set WAYBACK_MACHINE_TEST_AVAILABILITY_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
        ...
        $availability_ref01_data_dt0_loaded = $availability_ref01_ent->load($availability_ref01_match_dt0, null);
...
function availability_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("WAYBACK_MACHINE_TEST_AVAILABILITY_ENTID");
    ...
    if ($env["WAYBACK_MACHINE_TEST_LIVE"] === "TRUE") {
