...
// WaybackMachine SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (WaybackMachineSDK::test)
...
{
    private const SDK_CLASS = 'WaybackMachineSDK';
    ...
    private const SDK_BASE = 'waybackmachine_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../waybackmachine_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
