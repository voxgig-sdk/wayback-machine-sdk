...
// WaybackMachine SDK pipeline test
//
...
{
    private static function utility(): WaybackMachineUtility
    {
        return new WaybackMachineUtility();
    }
    ...
    private static function ctx(array $over = []): WaybackMachineContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new WaybackMachineContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new WaybackMachineOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof WaybackMachineError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new WaybackMachineOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = WaybackMachineMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new WaybackMachineOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = WaybackMachineMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new WaybackMachineOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = WaybackMachineMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new WaybackMachineSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = WaybackMachineMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new WaybackMachineResponse([]),
            'result' => new WaybackMachineResult([]),
        ]);
        [, $err] = WaybackMachineMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new WaybackMachineSpec([]),
            'response' => null,
            'result' => new WaybackMachineResult([]),
        ]);
        [, $err] = WaybackMachineMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new WaybackMachineSpec(['step' => 's']),
            'response' => new WaybackMachineResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new WaybackMachineResult([]),
        ]);
        [, $err] = WaybackMachineMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new WaybackMachineSpec(['step' => 's']),
            'response' => new WaybackMachineResponse(self::resp(200, ['v' => 1])),
            'result' => new WaybackMachineResult([]),
        ]);
        [, $err] = WaybackMachineMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new WaybackMachineSpec(['step' => 's']),
            'response' => new WaybackMachineResponse(self::resp(200, ['v' => 2])),
            'result' => new WaybackMachineResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        WaybackMachineMakeResponse::call($ctx);
    ...
    {
        $preset = new WaybackMachineResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new WaybackMachineSpec([]),
            'response' => new WaybackMachineResponse([]),
            'result' => new WaybackMachineResult([]),
        ...
        [$got, $err] = WaybackMachineMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new WaybackMachineResult([])]);
        [, $err] = WaybackMachineMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new WaybackMachineSpec([]), 'result' => null]);
        [, $err] = WaybackMachineMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new WaybackMachineSpec(['step' => 's']),
            'result' => new WaybackMachineResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new WaybackMachineOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = WaybackMachineMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new WaybackMachineSpec(['step' => 's']),
            'result' => new WaybackMachineResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new WaybackMachineOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = WaybackMachineMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new WaybackMachineResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new WaybackMachineSpec([]),
            'result' => new WaybackMachineResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = WaybackMachineMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = WaybackMachineMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new WaybackMachineError('boom', 'boom');
        $utility->fetcher = function (WaybackMachineContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new WaybackMachineSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = WaybackMachineMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (WaybackMachineContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = WaybackMachineMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(WaybackMachineResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        WaybackMachineMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (WaybackMachineContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new WaybackMachineSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = WaybackMachineMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new WaybackMachineResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new WaybackMachineSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = WaybackMachineMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = WaybackMachineMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = WaybackMachineMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new WaybackMachineResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, WaybackMachineDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new WaybackMachineResult(['ok' => false])]);
        $this->expectException(WaybackMachineError::class);
        WaybackMachineDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new WaybackMachineResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', WaybackMachineMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        WaybackMachineMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new WaybackMachineBaseFeature();
        $b = new WaybackMachineBaseFeature();
        WaybackMachineFeatureAdd::call($ctx, $a);
        WaybackMachineFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): WaybackMachineBaseFeature
    {
        $f = new WaybackMachineBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        WaybackMachineFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): WaybackMachineContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new WaybackMachineSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = WaybackMachinePrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        WaybackMachinePrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new WaybackMachineResponse(['headers' => null]),
            'result' => new WaybackMachineResult([]),
        ]);
        WaybackMachineResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        WaybackMachineResultBody::call($ctx);
