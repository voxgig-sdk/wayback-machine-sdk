# WaybackMachine PHP SDK Reference

Complete API reference for the WaybackMachine PHP SDK.
...
#### `WaybackMachineSDK::test($testopts = null, $sdkopts = null)`
...
| --- | --- | --- | --- |
| `closest` | `array` | No | Information about the closest available snapshot |
