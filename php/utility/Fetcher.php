...
// WaybackMachine SDK utility: fetcher

class WaybackMachineFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; WaybackMachineSDK/1.0)';
    ...
    public static function call(WaybackMachineContext $ctx, string $fullurl, array $fetchdef): array
    {
