...
// WaybackMachine SDK ratelimit feature
...
class WaybackMachineRatelimitFeature extends WaybackMachineBaseFeature
{
    ...
    private function _acquire(WaybackMachineContext $ctx): void
    {
    ...
    private function _track(WaybackMachineContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
