...
// WaybackMachine SDK cache feature
...
class WaybackMachineCacheFeature extends WaybackMachineBaseFeature
{
    ...
    private function _through(WaybackMachineContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
