...
// WaybackMachine SDK netsim feature
...
class WaybackMachineNetsimFeature extends WaybackMachineBaseFeature
{
    ...
    private function _simulate(WaybackMachineContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(WaybackMachineContext $ctx, array $applied): void
    {
        $client = $this->client;
