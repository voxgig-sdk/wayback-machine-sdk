...
// WaybackMachine SDK timeout feature
...
class WaybackMachineTimeoutFeature extends WaybackMachineBaseFeature
{
    ...
    private function _with_timeout(WaybackMachineContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(WaybackMachineContext $_ctx, float $ms): void
    {
        $client = $this->client;
