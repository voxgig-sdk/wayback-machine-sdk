...
The Wayback Machine API enables developers to check if a specific URL has been archived and is accessible in the Wayback Machine.

Learn more about Wayback Machine API at [archive.org/help/wayback_api.php](https://archive.org/help/wayback_api.php).
