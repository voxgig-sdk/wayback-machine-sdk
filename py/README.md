# WaybackMachine Python SDK



The Python SDK for the WaybackMachine API — an entity-oriented client following Pythonic conventions.

The SDK exposes the API as capitalised, semantic **Entities** — for example `client.Availability()` — each
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/wayback-machine-sdk/releases)) or
...
```python
client = WaybackMachineSDK.test(testopts, sdkopts)
```
...
```
py/
├── waybackmachine_sdk.py         -- Main SDK module
...
The main module (`waybackmachine_sdk`) exports the SDK class.
