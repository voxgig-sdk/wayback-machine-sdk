...
from waybackmachine_sdk.utility import register

# Load features
from waybackmachine_sdk.feature.base_feature import WaybackMachineBaseFeature
from waybackmachine_sdk.features import _has_feature, _make_feature
...
class WaybackMachineSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = WaybackMachineUtility()
        self._utility = utility

        from waybackmachine_sdk.config import shared_config
    ...
    def get_utility(self):
        return WaybackMachineUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("WaybackMachineSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Availability(self, data=None) -> "AvailabilityEntity":
        ...
        from waybackmachine_sdk.entity.availability_entity import AvailabilityEntity
