...
from waybackmachine_sdk.waybackmachine_types import (
    Availability,
...
class AvailabilityEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return AvailabilityEntity(self._client, opts)
    ...
    def load(self, reqmatch=None, ctrl=None) -> Availability:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.Availability().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
