# WaybackMachine SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions WaybackMachineSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both WaybackMachineSDK(...) and WaybackMachineSDK.test(...) become
#      WaybackMachineSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "waybackmachine_sdk"
_SDK_CLASS = "WaybackMachineSDK"
