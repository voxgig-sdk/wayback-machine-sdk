...
class WaybackMachineTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = WaybackMachineTestRunner.getenv("WAYBACKMACHINE_TEST_LIVE")
        override = WaybackMachineTestRunner.getenv("WAYBACKMACHINE_TEST_OVERRIDE")
        ...
        explain = WaybackMachineTestRunner.getenv("WAYBACKMACHINE_TEST_EXPLAIN")
