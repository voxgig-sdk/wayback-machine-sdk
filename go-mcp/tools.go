...
type Args struct {
	Entity string         `json:"entity" jsonschema:"availability"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.WaybackMachineSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "wayback-machine_list",
		Description: "List records from WaybackMachine. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "wayback-machine_load",
		Description: "Load a single record from WaybackMachine. " +
...
func runOp(client *sdk.WaybackMachineSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.WaybackMachineSDK, name string) (sdk.WaybackMachineEntity, error) {
	switch strings.ToLower(name) {
	case "availability":
		return client.Availability(nil), nil
