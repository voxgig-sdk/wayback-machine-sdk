// Command WaybackMachine-mcp is an MCP server exposing the WaybackMachine
// SDK as MCP tools.
//
// Two tools are registered:
//
//	WaybackMachine_list  — list records of an entity
//	WaybackMachine_load  — load a single record of an entity
//
