...
local AvailabilityEntity = {}
AvailabilityEntity.__index = AvailabilityEntity


function AvailabilityEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, AvailabilityEntity)
...
function AvailabilityEntity:get_name()
  return self._name
end


function AvailabilityEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return AvailabilityEntity.new(self._client, opts)
end
...
function AvailabilityEntity:mark_deleted()
  self._deleted = true
end


function AvailabilityEntity:deleted()
  return true == self._deleted
end


function AvailabilityEntity:data_set(args)
  if args ~= nil then
...
function AvailabilityEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function AvailabilityEntity:match_set(args)
  if args ~= nil then
...
function AvailabilityEntity:match_get()
...
function AvailabilityEntity:stream(action, args, callopts)
...
---@param reqmatch AvailabilityLoadMatch
---@param ctrl? table
---@return Availability
---@return string? err
function AvailabilityEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function AvailabilityEntity:_run_op(ctx, post_done)
  local utility = self._utility
