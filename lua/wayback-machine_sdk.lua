...
local WaybackMachineSDK = {}
WaybackMachineSDK.__index = WaybackMachineSDK
...
WaybackMachineSDK._make_feature = _make_feature


function WaybackMachineSDK.new(options)
  local self = setmetatable({}, WaybackMachineSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function WaybackMachineSDK:options_map()
...
function WaybackMachineSDK:get_utility()
  return Utility.copy(self._utility)
end


function WaybackMachineSDK:get_root_ctx()
  return self._rootctx
end


function WaybackMachineSDK:prepare(fetchargs)
...
function WaybackMachineSDK:direct(fetchargs)
...
-- by passing it.
function WaybackMachineSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function WaybackMachineSDK:graphql(query, variables, ctrl)
  ...
  if type(errors) == "table" and 0 < #errors then
    ...
    res.ok = false
    res.err = "WaybackMachineSDK: graphql: " .. msg
    res.graphql = errors
  end
...
function WaybackMachineSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = WaybackMachineSDK.new(sdkopts)
  sdk.mode = "test"
