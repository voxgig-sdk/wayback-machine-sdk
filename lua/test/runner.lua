...
function runner.env_override(m)
  local live = runner.getenv("WAYBACKMACHINE_TEST_LIVE")
  local override = runner.getenv("WAYBACKMACHINE_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("WAYBACKMACHINE_TEST_EXPLAIN")
