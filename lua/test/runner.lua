...
function runner.env_override(m)
  local live = runner.getenv("WAYBACK_MACHINE_TEST_LIVE")
  local override = runner.getenv("WAYBACK_MACHINE_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("WAYBACK_MACHINE_TEST_EXPLAIN")
