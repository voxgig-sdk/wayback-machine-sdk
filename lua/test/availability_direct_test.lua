...
describe("AvailabilityDirect", function()
  it("should direct-load-availability", function()
    local setup = availability_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-availability", setup.live and "live" or "unit")
