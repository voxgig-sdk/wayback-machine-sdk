# WaybackMachine Ruby SDK



The Ruby SDK for the WaybackMachine API — an entity-oriented client using idiomatic Ruby conventions.
...
raise a `WaybackMachineError` (a `StandardError` subclass), so wrap
...
```
rb/
├── WaybackMachine_sdk.rb       -- Main SDK module
