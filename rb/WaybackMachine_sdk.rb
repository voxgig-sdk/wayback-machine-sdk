...
require_relative 'WaybackMachine_types'
...
class WaybackMachineSDK
  ...
  def initialize(options = {})
    ...
    feature_opts = WaybackMachineHelpers.to_map(VoxgigStruct.getprop(@options, "feature"))
    if feature_opts
      featureorder = VoxgigStruct.getpath(@options, "__derived__.featureorder")
      if featureorder.is_a?(Array)
        featureorder.each do |fname|
          fopts = WaybackMachineHelpers.to_map(feature_opts[fname])
          if fopts && fopts["active"] == true
            utility.feature_add.call(@_rootctx, WaybackMachineFeatures.make_feature(fname))
          end
        end
      end
    end
  ...
  def get_utility
    WaybackMachineUtility.copy(@_utility)
  end
  ...
  def prepare(fetchargs = {})
    ...
    ctrl = WaybackMachineHelpers.to_map(VoxgigStruct.getprop(fetchargs, "ctrl")) || {}
    ...
    params = WaybackMachineHelpers.to_map(VoxgigStruct.getprop(fetchargs, "params")) || {}
    query = WaybackMachineHelpers.to_map(VoxgigStruct.getprop(fetchargs, "query")) || {}
  ...
  def raw_request(fetchargs = {})
    ...
    rescue WaybackMachineError => err
    ...
    if fetched.is_a?(Hash)
      status = WaybackMachineHelpers.to_int(VoxgigStruct.getprop(fetched, "status"))
  ...
  def graphql(query, variables = nil, ctrl = nil)
    ...
    if errors.is_a?(Array) && !errors.empty?
      ...
      res["ok"] = false
      res["err"] = WaybackMachineError.new(
        "graphql_error", "WaybackMachineSDK: graphql: #{msg}")
      res["graphql"] = errors
    end
  ...
  def self.test(testopts = nil, sdkopts = nil)
    ...
    sdk = WaybackMachineSDK.new(sdkopts)
    sdk.mode = "test"
    sdk
  end
end
