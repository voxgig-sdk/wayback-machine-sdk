// Command WaybackMachine-cli is a CLI + REPL for the WaybackMachine SDK,
...
const prompt = "wayback-machine"

// entitiesHelp is the space-separated entity list shown by /help.
const entitiesHelp = "availability"
...
func usage(out io.Writer) {
	...
	fmt.Fprintln(out, "Env:      WAYBACK_MACHINE_APIKEY (api key), WAYBACK_MACHINE_BASE (base url override)")
...
func run(args []string, in io.Reader, out, errOut io.Writer) int {
	...
	// Configure from the environment: WAYBACK_MACHINE_APIKEY carries the API key and
	// WAYBACK_MACHINE_BASE optionally overrides the API base URL (e.g. production).
	// Both injectable by a secrets vault. Unset -> nil config defaults.
	var opts map[string]any
	if apikey := os.Getenv("WAYBACK_MACHINE_APIKEY"); apikey != "" {
		opts = map[string]any{"apikey": apikey}
	}
	if base := os.Getenv("WAYBACK_MACHINE_BASE"); base != "" {
		if opts == nil {
			opts = map[string]any{}
		}
		opts["base"] = base
	}
	client := sdk.NewWaybackMachineSDK(opts)
