...
func registerSDKWords(r *eng.Registry, client *sdk.WaybackMachineSDK) {
...
func runOp(client *sdk.WaybackMachineSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
