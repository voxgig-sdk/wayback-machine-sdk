...
func (sdk *WaybackMachineSDK) OptionsMap() map[string]any {
...
func (sdk *WaybackMachineSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *WaybackMachineSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *WaybackMachineSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *WaybackMachineSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *WaybackMachineSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath(sdk.options, []any{"allow", "op"}).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *WaybackMachineSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath(sdk.options, []any{"allow", "op"}).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("WaybackMachineSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *WaybackMachineSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *WaybackMachineSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("WaybackMachineSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *WaybackMachineSDK {
	...
	sdk := NewWaybackMachineSDK(sdkopts)
	sdk.Mode = "test"
