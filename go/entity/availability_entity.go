...
func NewAvailabilityEntity(client *core.WaybackMachineSDK, entopts map[string]any) *AvailabilityEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *AvailabilityEntity) GetName() string { return e.name }
...
func (e *AvailabilityEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *AvailabilityEntity) Deleted() bool {
	return e.deleted
}


func (e *AvailabilityEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewAvailabilityEntity(e.client, opts)
}

func (e *AvailabilityEntity) Data(args ...any) any {
...
func (e *AvailabilityEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Availability; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *AvailabilityEntity) DataTyped(data ...Availability) Availability {
	if len(data) > 0 {
		return typedFrom[Availability](e.Data(asMap(data[0])))
	}
	return typedFrom[Availability](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Availability (all fields
// optional at the wire level).
func (e *AvailabilityEntity) MatchTyped(match ...Availability) Availability {
	if len(match) > 0 {
		return typedFrom[Availability](e.Match(asMap(match[0])))
	}
	return typedFrom[Availability](e.Match())
}
...
func (e *AvailabilityEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *AvailabilityEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// AvailabilityLoadMatch and returns an Availability. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *AvailabilityEntity) LoadTyped(reqmatch AvailabilityLoadMatch, ctrl map[string]any) (Availability, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Availability{}, err
	}
	return typedFrom[Availability](res), nil
}



func (e *AvailabilityEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *AvailabilityEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *AvailabilityEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *AvailabilityEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *AvailabilityEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
